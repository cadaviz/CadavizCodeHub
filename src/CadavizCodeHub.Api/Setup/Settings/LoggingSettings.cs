...
namespace CadavizCodeHub.Api.Setup.Settings
{
    public class LoggingSettings
    {
        public WriteLogTo WriteLogTo { get; set; } = WriteLogTo.Console;
        public LogLevel MinimumLogLevel { get; set; } = LogLevel.Information;
        public string OutputTemplate { get; set; } = "[{Timestamp:HH:mm:ss}] Properties:{Properties:j} at {SourceContext}{NewLine}[{Level:u3}] - Message:{Message}{NewLine}{Exception}";
